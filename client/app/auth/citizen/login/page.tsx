  ...
  return (
    <Card className="p-8">
      ...
      <div className="mt-6">
        ...
        <a
          className="mt-3 block rounded-2xl border border-slate-200 bg-white/80 px-4 py-3 text-center text-sm font-medium text-slate-800 shadow-sm transition hover:bg-white dark:border-slate-700/80 dark:bg-slate-950/40 dark:text-slate-100 dark:hover:bg-slate-900/50"
